                    ...
                    >
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                <h2 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#fff' }}>Worker Profile</h2>
                                <button
                                    onClick={closeProfile}
                                    style={{
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                                <div style={{ gridColumn: 'span 2' }}>
                                    <label style={{ fontSize: '0.75rem', color: '#888', display: 'block', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Full Name</label>
                                    <span style={{ fontWeight: 600, fontSize: '1.125rem', color: '#fff' }}>{worker.name}</span>
                                </div>
                                <div style={{ gridColumn: 'span 2' }}>
                                    ...
                                    <span style={{ color: '#a3a3a3' }}>{worker.email}</span>
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.75rem', color: '#888', display: 'block', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Phone</label>
                                    <span style={{ color: '#a3a3a3' }}>{worker.phone || 'Not provided'}</span>
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.75rem', color: '#888', display: 'block', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Date of Birth</label>
                                    <span style={{ color: '#a3a3a3' }}>{worker.dob || 'Not provided'}</span>
                                </div>
                                <div style={{ gridColumn: 'span 2' }}>
                                    <label style={{ fontSize: '0.75rem', color: '#888', display: 'block', marginBottom: '0.25rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>School / Institution</label>
                                    <span style={{ color: '#a3a3a3' }}>{worker.school || 'Not provided'}</span>
                                </div>
                                <div style={{ gridColumn: 'span 2' }}>
                                    <label style={{ fontSize: '0.75rem', color: '#888', display: 'block', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Work Pass Type</label>
                                    <span
                                        className="badge"
                                        style={{
