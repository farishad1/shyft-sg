...
export function SettingsForm() {
    ...
    return (
        <>
            ...
            <div style={{
                background: '#FFFFFF', border: '1px solid #E2D3C2', borderRadius: 'var(--radius-md)',
                padding: '1.5rem',
            }}>
            ...
            <div style={{
                ...
                <p style={{ color: '#9C8F84', fontSize: '0.8125rem', marginBottom: '1rem' }}>
                    Pre-fill these values when creating new shift postings.
                </p>

                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
                    <div>
                        <label style={{ display: 'block', color: '#9C8F84', fontSize: '0.75rem', marginBottom: '0.375rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                            Position
                        </label>
                        <input
                            type="text"
                            ...
                            style={{
                                width: '100%', padding: '0.625rem', background: '#FAF6F0', border: '1px solid #E2D3C2',
                                borderRadius: 'var(--radius-sm)', color: '#5C524A', fontSize: '0.875rem',
                            }}
                        />
                    </div>
                    <div>
                ...
                <button
                    ...
                    style={{
                        ...
                        background: saved ? '#22c55e' : 'var(--accent)', color: '#FFFFFF',
...
function ToggleRow({
    ...
    return (
        <div style={{
            ...
            padding: '0.75rem 1rem', background: '#FAF6F0', borderRadius: 'var(--radius-sm)',
            border: '1px solid #E2D3C2',
        }}>
            <div>
                <div style={{ fontWeight: 600, fontSize: '0.9375rem' }}>{label}</div>
                <div style={{ color: '#9C8F84', fontSize: '0.8125rem' }}>{description}</div>
            </div>
            <button
                onClick={() => onChange(!checked)}
                style={{
                    width: '3rem', height: '1.5rem', borderRadius: '999px', border: 'none',
                    background: checked ? 'var(--accent)' : '#E2D3C2', cursor: 'pointer',
